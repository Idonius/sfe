...
import ec.facturacion.electronica.services.CompanyFacade;
...
public class CompanyController implements Serializable {
    ...
    @EJB
    private ec.facturacion.electronica.services.CompanyFacade ejbFacade;
    ...
    public void create() {
        persist(PersistAction.CREATE, ResourceBundle.getBundle("ec.facturacion.electronica.util.Bundle").getString("CompanyCreated"));
    ...
    public void update() {
        persist(PersistAction.UPDATE, ResourceBundle.getBundle("ec.facturacion.electronica.util.Bundle").getString("CompanyUpdated"));
    }

    public void destroy() {
        persist(PersistAction.DELETE, ResourceBundle.getBundle("ec.facturacion.electronica.util.Bundle").getString("CompanyDeleted"));
        if (!JsfUtil.isValidationFailed()) {
