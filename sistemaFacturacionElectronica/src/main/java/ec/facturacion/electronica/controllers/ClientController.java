...
public class ClientController implements Serializable {
    ...
    @EJB
    private ec.facturacion.electronica.services.ClientFacade ejbFacade;
    ...
    public void create() {
        persist(PersistAction.CREATE, ResourceBundle.getBundle("ec.facturacion.electronica.util.Bundle").getString("ClientCreated"));
    ...
    public void update() {
        persist(PersistAction.UPDATE, ResourceBundle.getBundle("ec.facturacion.electronica.util.Bundle").getString("ClientUpdated"));
    }

    public void destroy() {
        persist(PersistAction.DELETE, ResourceBundle.getBundle("ec.facturacion.electronica.util.Bundle").getString("ClientDeleted"));
        if (!JsfUtil.isValidationFailed()) {
    ...
    public static class ClientControllerConverter implements Converter {
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof Client) {
                ...
                return getStringKey(o.getCliCode());
            } else {
