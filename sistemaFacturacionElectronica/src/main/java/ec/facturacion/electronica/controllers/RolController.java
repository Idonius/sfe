...
import ec.facturacion.electronica.services.RolFacade;
...
public class RolController implements Serializable {
    ...
    @EJB
    private ec.facturacion.electronica.services.RolFacade ejbFacade;
    ...
    public void create() {
        persist(PersistAction.CREATE, ResourceBundle.getBundle("ec.facturacion.electronica.util.Bundle").getString("RolCreated"));
    ...
    public void update() {
        persist(PersistAction.UPDATE, ResourceBundle.getBundle("ec.facturacion.electronica.util.Bundle").getString("RolUpdated"));
    }

    public void destroy() {
        persist(PersistAction.DELETE, ResourceBundle.getBundle("ec.facturacion.electronica.util.Bundle").getString("RolDeleted"));
        if (!JsfUtil.isValidationFailed()) {
