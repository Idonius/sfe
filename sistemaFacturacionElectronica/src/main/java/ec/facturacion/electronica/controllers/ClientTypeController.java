...
import ec.facturacion.electronica.services.ClientTypeFacade;
...
@ManagedBean(name = "clientTypeController")
@SessionScoped
public class ClientTypeController implements Serializable {

    @EJB
    private ec.facturacion.electronica.services.ClientTypeFacade ejbFacade;
    ...
    public void create() {
        persist(PersistAction.CREATE, ResourceBundle.getBundle("ec.facturacion.electronica.util.Bundle").getString("ClientTypeCreated"));
    ...
    public void update() {
        persist(PersistAction.UPDATE, ResourceBundle.getBundle("ec.facturacion.electronica.util.Bundle").getString("ClientTypeUpdated"));
    }

    public void destroy() {
        persist(PersistAction.DELETE, ResourceBundle.getBundle("ec.facturacion.electronica.util.Bundle").getString("ClientTypeDeleted"));
        if (!JsfUtil.isValidationFailed()) {
    ...
    public static class ClientTypeControllerConverter implements Converter {
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof ClientType) {
                ...
                return getStringKey(o.getCliTypCode());
            } else {
